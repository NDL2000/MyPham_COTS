...
<head>
    ...
    <link  rel="stylesheet" href="./assets/css/QLBanner/suaBanner.css"/>
...
<body>
    ...
    <?php if(isset($old1)&&$old1>0){echo "<script>window.location.href='./index.php?url=DSBanner&kq=2&page=1'</script>";} ?>
</body>
</html>
<script>
    function goBack(){
    ...
    function sua(name){
        return confirm("Bạn có muốn cập nhật banner : "+ name +" ?");
    }
</script>
