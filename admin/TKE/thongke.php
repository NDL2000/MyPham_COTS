...
<body>
  ...
  if (isset($_GET['page']) && $_GET['page'] > 0) {
    ...
    $page = 1;
    echo "<script>window.location.href='./index.php?url=thongke&page=1'</script>";
  }

  $qr = "SELECT * FROM hoadon,thue where TrangThai= 'Đã giao' and MaNCC='$mancc' and hoadon.NgayHD BETWEEN thue.TuNgay AND thue.DenNgay limit $page,$rows";
  ...
  <table class="table table-bordered table-hover table-1">
    <thead class="table-success">
      <tr>
        ...
        <th scope="col" class="title-table" style="width: 10%">Thuế</th>
    ...
    <tbody>
      ...
      ?>
            <tr>
              ...
              <td> <?php echo number_format($tongtien * $row['TyLeThue'] / 100, "0", ",", ".") . " VNĐ"; ?> </td>
              <td>
      ...
      <?php } ?>
      <tr>
        <td colspan="5" style="font-weight:bold">Tổng thuế</td>
        <td style="font-weight:bold;color:red"><?php echo number_format($vat, "0", ",", ".") . " VNĐ"; ?></td>
      </tr>
    </tbody>
  </table>
