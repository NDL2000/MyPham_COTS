...
$sql_update = "SELECT sp.MaSP,sp.MaNCC,sp.TenSP,sp.TyLeThue,nx.GiaNhap,nx.GiaXuat,sp.HinhAnh,sp.MaDM,sp.TrangThai,nx.SoLuongNhap,sp.MoTa,nx.NgayApDung FROM sanpham as sp,nhapxuat as nx where sp.MaSP=nx.MaSP and nx.GiaXuat = sp.DonGia and sp.MaSP=$id and nx.MaSP=$id";
...
if (isset($_POST['sbm'])) {
  ...
  $sql_QLSP_update = "UPDATE sanpham SET MaNCC='$prd_supplier', TenSP = '$prd_name', DonGia= '$price_output', HinhAnh = '$image1', MaDM= '$category_id', TrangThai= '$status1',MoTa='$description',SoLuongTon='$input_quality',TyLeThue='$tax' where MaSP='$id'";
  ...
  <div class="card-body">
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" name="input_tax" class="form-control" require value="<?php echo  $row_update['TyLeThue'] ?>" min="0">
      </div>
      <div class="form-group">
