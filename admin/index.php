...
<body>
			...
			if (isset($_GET['url'])) {
				switch ($_GET['url']) {
					...
					case 'dangxuat':
						...
						//Quan ly bai dang
					case 'DSBĐ':
						include './QLBĐ/DSBĐ.php';
						break;
					case 'xemCTBĐ':
						include './QLBĐ/xemCTBĐ.php';
						break;
					case 'themBĐ':
						include './QLBĐ/themBĐ.php';
						break;
					case 'xoaBĐ':
						include './QLBĐ/xoaBĐ_submit.php';
						break;
					case 'suaBĐ':
						include './QLBĐ/suaBĐ.php';
						break;
	...
	<?php if (isset($_SESSION['admin']) && isset($_GET['ad']) && $_GET['ad'] == 1) { ?>
		<script>
			swal("", "Xin chào," + " <?php if (isset($_SESSION['admin'])) echo $_SESSION['admin'];  ?> chào mừng bạn đến với trang quản trị viên của chúng tôi!", "success");
		</script>
	<?php } ?>
	<?php if (isset($_SESSION['admin-NCC']) && isset($_GET['ad']) && $_GET['ad'] == 2) { ?>
		<script>
			swal("", "Xin chào," + " <?php if (isset($_SESSION['admin-NCC'])) echo $_SESSION['admin-NCC'];  ?> chào mừng bạn đến với trang quản trị viên của chúng tôi!", "success");
		</script>
	<?php } ?>
</body>
