...
<body>
  ...
  if (isset($_GET['page']) && $_GET['page'] > 0) {
    ...
    $page = 1;
    echo "<script>window.location.href='./index.php?url=thongkedt&page=1'</script>";
  }
    ...
    <form method="post" action="<?php include("loc.php"); ?>">
      <table class="table-date">
        ...
        <tr>
          ...
          <td> <input type="numeric" name="rate" id="rate"> </td>
        </tr>
      </table>
      <br>
  ...
  <table class="table table-bordered table-hover table-1">
    <thead class="table-success">
      <tr>
        ...
        <th scope="col" class="title-table" style="width: 10%">Doanh thu NCC</th>
        <th scope="col" class="title-table" style="width: 10%">Doanh thu Nhà quản trị</th>
      </tr>
    </thead>
    <tbody>
      <?php
      ...
      ?>
          <tr>
            ...
            <td> <?php echo number_format($doanhthu * $rate / 100, "0", ",", ".") . " VNĐ"; ?> </td>
          </tr>
      <?php }
      } ?>
      <td colspan="3" align="right" style="font-weight: bold;font-size: 20px;color:red">Tổng doanh thu</td>
      <td style="font-weight: bold;font-size: 20px;color:green"> <?php echo number_format($thue, "0", ",", ".") . " VNĐ"; ?> </td>
    </tbody>
