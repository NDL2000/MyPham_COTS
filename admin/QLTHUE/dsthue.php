...
<body>
    <div class="container-qldm">
        <h1 class="title">DANH SÁCH THUẾ</h1>
        <table class="table table-hover table-qldm">
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <a href="./index.php?url=suathue&id=<?php echo $row["ID"]; ?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
                            <a href="./index.php?url=xoathue&id=<?php echo $row["ID"]; ?>" class="btn btn-danger" onclick="return xoa('<?php echo $row['ID']; ?>')"><i class="fas fa-times"></i></a>
                        </td>
                    </tr>
            <?php }
            }  ?>
...
<script>
    function myFunction() {
        location.replace("./index.php?url=themthue");
    }

    function xoa(name) {
        return confirm("Bạn có muốn ma thue : " + name + " ?");
    }
</script>
