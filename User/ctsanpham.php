...
<head>
	...
	<style id="custom-css" type="text/css">
		...
		.shop-page-title.featured-title .title-bg {
			background-image: url(http://mauweb.monamedia.net/hachi/wp-content/uploads/2020/05/AnyConv.com__olive_oil_shampoo_350_master.png) !important;
		}
...
<body class="product-template-default single single-product postid-306 theme-flatsome woocommerce woocommerce-page woocommerce-no-js header-shadow lightbox">
	...
	<div class="col large-9">
		<div class="row">
			...
			if (isset($_GET["id"])) {
				$MaSP = $_GET["id"];
				$qr = "SELECT * FROM sanpham as sp,danhmuc dm, nhacungcap cc where sp.MaDM=dm.MaDM and sp.MaNCC=cc.MaNCC and sp.TrangThai='1'and MaSP='$MaSP'";
			} else {
				$qr = "SELECT * FROM sanpham as sp,danhmuc dm,nhacungcap cc where sp.MaDM=dm.MaDM and sp.MaNCC=cc.MaNCC and sp.TrangThai='1'and MaSP='$MaSP'";
			}
			$result = mysqli_query($conn, $qr);
			...
			?>
					<div class="product-info summary entry-summary col col-fit product-summary">
						...
						<h4>Nhà cung cấp: <?php echo $row["TenNCC"]?></h4>
    ...
    border-radius: 10px;display:none">
											<p id="alert_content" style="margin-top: 5px;"></p>
										</div>
									</div>
	...
	<script type='text/javascript'>
		...
		var _wpUtilSettings = {
			"ajax": {
				"url": "\/hachi\/wp-admin\/admin-ajax.php"
			}
		};
		/* ]]> */
	</script>
